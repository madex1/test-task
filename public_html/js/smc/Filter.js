...
function filter() {
	...
	this.setTemplate = function(template) {
		var templateId = parseInt(template);
	...
	*/
	this.getQueryString = function(_MergeFilter) {
		...
		var template = (_MergeFilter instanceof Object ? _MergeFilter.Template || this.Template : this.Template);
		if (template) {
			QueryPieces.push('templates=' + template);
		}
