	...
	tinymce.create('tinymce.themes.UmiSimpleTheme', {
		...
		_mceImage : function(ui, val) {
			...
			ed.windowManager.open({
				...
				width : 400 + parseInt(ed.getLang('umisimple.image_delta_width', 0)),
				height : 300 + parseInt(ed.getLang('umisimple.image_delta_height', 0)),
				inline : true
			}, {
		...
		_mceLink : function(ui, val) {
			...
			ed.windowManager.open({
				...
				width : 340 + parseInt(ed.getLang('umisimple.link_delta_width', 0)),
				height : 225 + parseInt(ed.getLang('umisimple.link_delta_height', 0)),
				inline : true
			}, {
				theme_url : tinymce.baseURL + '/themes/umisimple'
			});
