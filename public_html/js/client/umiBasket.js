/**
 * Модуль корзины для старого umi-модуля eshop.
...
umiBasket.prototype.onAfterAddElement = function (iElementId, iCount) {
	...
	for (iI = 0; iI < oButtons.length; iI++) {
		oButtons[iI].innerHTML = "<a href=\"/eshop/basket/\">" + getLabel('js-client-umiBasket-in_cart', iCount)  +
		"</a> | <a href=\"javascript:umiBasket.getInstance().addElement("+iElementId+");\">+1</a>";
	}
