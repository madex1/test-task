		...
		<div class="field text">			
			...
			<div class="item_add_blocks">
				...
				<div class="customPages">
					<div class="customPagesWrap formClass">
						<h2>&label-menu-add-link;</h2>
						<p id="custom-name-block">
							<label for="custom-name">
								<span>&label-menu-add-link-title;</span>
								<input type="text" value="&label-menu-add-link-title-value;" class="text" name="custom-name" id="custom-name" onblur="javascript: if(this.value == '') this.value = '&label-menu-add-link-title-value;';" onfocus="javascript: if(this.value == '&label-menu-add-link-title-value;') this.value = '';"/>
							</label>
						</p>
						<p id="custom-url-block">
							<label for="custom-url">
								<span>&label-menu-add-link-url;</span>
								<input type="text" value="&label-menu-add-link-url-value;" class="text" name="custom-url" id="custom-url" onblur="javascript: if(this.value == '') this.value = '&label-menu-add-link-url-value;';" onfocus="javascript: if(this.value == '&label-menu-add-link-url-value;') this.value = '';"/>
							</label>
						</p>
			...
			<link href="/styles/skins/mac/data/modules/menu/style.css" rel="stylesheet" type="text/css" />
			<link href="/styles/skins/mac/data/modules/menu/nestable.css" rel="stylesheet" type="text/css" />
			<script type="text/javascript" src="/styles/skins/mac/data/modules/menu/jquery.nestable.js" />
			<script type="text/javascript" src="/styles/skins/mac/data/modules/menu/menu.js" />
			<script type="text/javascript">
				var tmp_lang_id = <xsl:value-of select="$lang-id"/>;
			</script>
			<script type="text/javascript" src="/styles/skins/mac/data/modules/menu/tree.js" />
		</div>
	</xsl:template>
