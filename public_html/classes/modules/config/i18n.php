...
$i18n = Array(
	...
	'label-php-5-alert' => 'Вы используете устаревшую версию php %s, ее поддержка прекратится в 2018 году. Рекомендуем перевести проект на <a target="_blank" href="http://api.docs.umi-cms.ru/migraciya_na_php7/">php 7</a>.',
