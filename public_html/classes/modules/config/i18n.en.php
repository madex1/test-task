...
$i18n = Array(
	...
	'js-label-delete-extension-warning-text' => 'You are about to delete an extension, this permanently delete the extension files and can break your site.',
	...
	'label-php-5-alert' => 'You are using an outdated version of php %s, its support will end in 2018. We recommend you to migrate the project to <a target="_blank" href="http://api.docs.umi-cms.ru/migraciya_na_php7/">php 7</a>.',
