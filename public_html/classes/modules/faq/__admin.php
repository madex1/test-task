	...
	abstract class __faq extends baseModuleAdmin {
		...
		public function config() {
			...
			if($mode == "do") {
				...
				$regedit->setVar("//modules/faq/disable_new_question_notification", $params['config']['boolean:disable_new_question_notification']);
				$this->chooseRedirect();
			}
			...
			$params['config']['boolean:disable_new_question_notification'] = (int) $regedit->getVal("//modules/faq/disable_new_question_notification");
