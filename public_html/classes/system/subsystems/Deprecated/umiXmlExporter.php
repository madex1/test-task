...
END;    unset($vf09cc7ee3a9a93273f4b80601cafb00c);}unset($vd05b6ed7d2345020440df396d6da7f73);return $v74693d2fc58b46bd06410f278e39aa71;}protected function parseValues(umiObject $va8cfde6331bd59eb2ac96f8911c4b666, umiField $v06e3d36fa30cea095545139854ad1fb9) {$v519504d7d4beb745dac24ccfb6c1d7c9 = $v06e3d36fa30cea095545139854ad1fb9->getFieldType();$v5c4e252909242b24243818048235620d = (int) $v519504d7d4beb745dac24ccfb6c1d7c9->getIsMultiple();$v983560f49ede87197144b22c810a5087 = (string) $v519504d7d4beb745dac24ccfb6c1d7c9->getDataType();$vf09cc7ee3a9a93273f4b80601cafb00c = $va8cfde6331bd59eb2ac96f8911c4b666->getValue($v06e3d36fa30cea095545139854ad1fb9->getName());$vf09cc7ee3a9a93273f4b80601cafb00c = (is_array($vf09cc7ee3a9a93273f4b80601cafb00c)) ? $vf09cc7ee3a9a93273f4b80601cafb00c : [$vf09cc7ee3a9a93273f4b80601cafb00c];switch ($v983560f49ede87197144b22c810a5087) {case "img_file": {$vde5b1cd11c4544e7f3fe792f2e0d8b8b = [];foreach ($vf09cc7ee3a9a93273f4b80601cafb00c as $vf19e92e810d08b6cf2d0265b779064d9) {if (!$vf19e92e810d08b6cf2d0265b779064d9) {continue;}$vde5b1cd11c4544e7f3fe792f2e0d8b8b[] = [       "value" => $vf19e92e810d08b6cf2d0265b779064d9->getFilePath()      ];}break;}case "relation": {$vde5b1cd11c4544e7f3fe792f2e0d8b8b = [];foreach ($vf09cc7ee3a9a93273f4b80601cafb00c as $vf19e92e810d08b6cf2d0265b779064d9) {$vf19e92e810d08b6cf2d0265b779064d9 = umiObjectsCollection::getInstance()->getObject($vf19e92e810d08b6cf2d0265b779064d9);if (!$vf19e92e810d08b6cf2d0265b779064d9) {continue;}$v818ad5ef6588e140ecb9f81e810c028a = $vf19e92e810d08b6cf2d0265b779064d9->getId();if (!in_array($v818ad5ef6588e140ecb9f81e810c028a, $this->objects)) {$this->objects[] = $v818ad5ef6588e140ecb9f81e810c028a;}$vde5b1cd11c4544e7f3fe792f2e0d8b8b[] = [       "value" => $vf19e92e810d08b6cf2d0265b779064d9->getName(),       "id" => $vf19e92e810d08b6cf2d0265b779064d9->getId()      ];}break;}case "symlink": {$vde5b1cd11c4544e7f3fe792f2e0d8b8b = [];foreach ($vf09cc7ee3a9a93273f4b80601cafb00c as $vf19e92e810d08b6cf2d0265b779064d9) {if (!$vf19e92e810d08b6cf2d0265b779064d9) {continue;}$vde5b1cd11c4544e7f3fe792f2e0d8b8b[] = [       "value" => $vf19e92e810d08b6cf2d0265b779064d9->getName(),       "id" => $vf19e92e810d08b6cf2d0265b779064d9->getId(),       "link" => $this->getDomainPath() . umiHierarchy::getInstance()->getPathById($vf19e92e810d08b6cf2d0265b779064d9->getId())      ];}break;}case "date": {$vde5b1cd11c4544e7f3fe792f2e0d8b8b = [];foreach ($vf09cc7ee3a9a93273f4b80601cafb00c as $vf19e92e810d08b6cf2d0265b779064d9) {if (!$vf19e92e810d08b6cf2d0265b779064d9) {continue;}$vde5b1cd11c4544e7f3fe792f2e0d8b8b[] = [       "timestamp" => $vf19e92e810d08b6cf2d0265b779064d9->getFormattedDate("U"),       "RFC" => $vf19e92e810d08b6cf2d0265b779064d9->getFormattedDate("r"),       "UTC" => $vf19e92e810d08b6cf2d0265b779064d9->getFormattedDate(DATE_ATOM)      ];}break;}default: {$vde5b1cd11c4544e7f3fe792f2e0d8b8b = [];foreach ($vf09cc7ee3a9a93273f4b80601cafb00c as $vf19e92e810d08b6cf2d0265b779064d9) {$vde5b1cd11c4544e7f3fe792f2e0d8b8b[] = [       "value" => $vf19e92e810d08b6cf2d0265b779064d9,       "id" => null      ];}break;}}$vf09cc7ee3a9a93273f4b80601cafb00c = "";foreach ($vde5b1cd11c4544e7f3fe792f2e0d8b8b as $v3a6d0284e743dc4a9b86f97d6dd1a3bf) {if (array_key_exists('value', $v3a6d0284e743dc4a9b86f97d6dd1a3bf)) {$v2063c1608d6e0baf80249c42e2be5804 = $v3a6d0284e743dc4a9b86f97d6dd1a3bf['value'];}if (array_key_exists('id', $v3a6d0284e743dc4a9b86f97d6dd1a3bf)) {if (array_key_exists('timestamp', $v3a6d0284e743dc4a9b86f97d6dd1a3bf)) {$vf09cc7ee3a9a93273f4b80601cafb00c .= <<<END
							<value>
