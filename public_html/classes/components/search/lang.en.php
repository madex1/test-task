<?php
	...
	Built-in search engine. Allows you to set the priority of the different parts of the document. <br />
	Index can be manually or automatically when you save a document.
