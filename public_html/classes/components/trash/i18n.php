<?php
	...
	$i18n = [
		...
		'header-trash-trash' => 'Корзина удаленных страниц',
		'perms-trash-trash' => 'Права на получение списка страниц и их восстановление',
		'perms-trash-delete' => 'Права на очищение корзины',
		'js-trash-empty' => 'Очистка корзины',
		'js-trash-empty-done' => 'Корзина очищена.',
		...
		'js-trash-confirm-text' => 'Все страницы в корзине будут безвозвратно удалены.',
		...
		'smc-restore' => 'Восстановить страницу',
	];
