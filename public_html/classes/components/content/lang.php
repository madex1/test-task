<?php
	...
	$C_LANG['module_description'] =
		'Модуль предназначен для управления текстовыми и графическими материалами сайта, работе с разделами, добавления новых материалов. ';
	...
	$C_LANG['getRecentPages'] = 'Вы недавно смотрели';
	...
	$LANG_EXPORT['content_error_insert_null'] =
		'Ошибка макроса (content insert): Вы не указали, какую страницу хотите вставить.';
