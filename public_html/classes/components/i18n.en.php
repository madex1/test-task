<?php
	...
	$i18n = [
		...
		'label-update_russianpost_types_on_update' => 'Update Russian Post types on update',
		...
		'label-filter_indexing_on_update' =>'Filter map indexation on system update',
		...
		'label-MigrateImgFileFields' => 'Image fields migration',
		...
		'label-MigrateDomainIdFields' => 'Migration of fields with domain id to "Link to domain" type',
		'label-ChangeType' => 'Change fields types',
		'label-MoveValue' => 'Move fields values',
		'label-MoveImageValues' => 'Move image fields values',
		...
		'label-module-admin-not-implemented' => 'Cannot use admin functions of module "%s".',
		'js-field-search' => 'search',
		'js-move-page-to-top' => 'Top',
		'js-move-page-to-bottom' => 'Bottom',
		...
		'js-add-copy' => 'Add copy',
		'js-add' => 'Add',
		'js-remove' => 'Remove',
		'js-copy' => 'Copy',
		'js-date-time-placeholder' => 'dd.mm.yyyy hh:mm',
		'js-date-placeholder' => 'dd.mm.yyyy',
		'js-time-placeholder' => 'hh:mm',
		...
		'js-notifications-variable-control' => 'Variables control',
		'js-handle-button-add' => 'Add',
		'js-handle-button-delete' => 'Delete',
		'js-label-search-button' => 'Search',
		'js-nothing-found' => 'Nothing found',
		'js-stub-login' => 'Login',
		'js-stub-password' => 'Password',
		'js-stub-enter' => 'Enter',
		'error-wrong-auth-params' => 'Wrong login or password',
		'error-wrong-url' => 'Wrong url'
	];
